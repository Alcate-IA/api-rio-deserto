    ...
    */
    ...
    private void atribuirClassificacoesEspecificas() {
        ...
        try {
            ...
            int[] aguasSuperficiais = {691, 883, 884, 856, 857, 885, 886, 887, 888, 889, 864, 865, 823, 824, 825, 826, 827, 828, 829, 830, 831, 832, 833, 834, 835, 836, 837, 838, 839, 840, 841, 842, 843, 844, 845, 890, 891, 906, 894};
            int[] piezometrosAguasSubterraneas = {313, 314, 84, 85, 86, 88, 93, 100, 109, 113, 121, 137, 140, 143, 145, 162, 163, 185, 590, 199, 206, 207, 208, 209, 211, 212, 213, 214, 215, 222, 232, 235, 238, 245, 247, 262, 263, 269, 275, 293, 294, 295, 296, 297, 298, 299, 300, 301, 302, 303, 304, 305, 306, 308, 309, 310, 311, 312, 315, 316, 317, 318, 319, 320, 321, 322, 323, 324, 325, 326, 327, 328, 329, 330, 331, 332, 333, 334, 335, 336, 337, 338, 339, 340, 341, 342, 343, 345, 346, 347, 349, 350, 351, 352, 353, 355, 356, 357, 358, 359, 360, 361, 362, 364, 365, 366, 367, 369, 372, 373, 378, 379, 380, 381, 382, 383, 384, 385, 386, 387, 388, 389, 390, 391, 392, 393, 395, 396, 397, 399, 400, 401, 403, 404, 407, 408, 409, 410, 411, 412, 413, 414, 415, 416, 417, 420, 425, 427, 428, 433, 435, 438, 440, 441, 447, 450, 451, 452, 453, 454, 455, 456, 457, 459, 460, 461, 462, 463, 464, 466, 467, 476, 477, 478, 479, 480, 481, 482, 483, 484, 485, 486, 487, 488, 489, 491, 492, 493, 495, 497, 498, 501, 502, 503, 504, 506, 507, 591, 574, 575, 576, 577, 578, 579, 580, 581, 582, 583, 584, 585, 586, 587, 736, 738, 681, 683, 688, 689, 661, 665, 692, 662, 663, 664, 693, 695, 698, 700, 701, 702, 658, 597, 598, 599, 600, 601, 602, 603, 604, 605, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616, 617, 618, 619, 620, 621, 622, 623, 624, 625, 626, 627, 629, 630, 631, 632, 633, 634, 635, 636, 637, 638, 639, 640, 641, 642, 643, 644, 645, 646, 647, 648, 649, 650, 651, 652, 653, 654, 655, 656, 657, 704, 705, 706, 707, 708, 709, 710, 711, 712, 713, 717, 718, 719, 721, 722, 723, 724, 726, 727, 728, 729, 733, 734, 735, 752, 753, 754, 755, 756, 757, 758, 759, 760, 761, 762, 763, 764, 765, 766, 850, 791, 792, 793, 794, 795, 796, 797, 798, 851, 852, 799, 800, 801, 802, 803, 804, 904, 854, 855, 866, 867, 868, 869, 870, 871, 872, 873, 874, 875, 907};

            // Converter arrays para Sets para busca mais eficiente
            ...
            Set<Integer> setPiezometrosAguasSubterraneas = Arrays.stream(piezometrosAguasSubterraneas).boxed().collect(Collectors.toSet());
            ...
            // Atualizar cada piezômetro com a classificação específica
            String updateQuery = "UPDATE tb_piezometro SET id_classificacao_agua = ? WHERE cd_piezometro = ?";
            int piezometrosAtualizados = 0;
            ...
            for (Integer cdPiezometro : piezometrosAtivos) {
                ...
                // Verificar em qual conjunto o piezômetro está
                if (setEfluentes.contains(cdPiezometro)) {
                    ...
                    semClassificacao++;
                    continue; // Não atualiza piezômetros que não estão em nenhum array
                }
            ...
            System.out.println("   Tempo atribuição de classificações: " + (fimClassificacao - inicioClassificacao) + "ms");
